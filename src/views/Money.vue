  ...
  <div id="money" >
    <Layout className="layout_one" ref="layout_one" key="101010">
      ...
      <div key="1002" class="billy_box">
        <transition name="list">
          <div class="info_box" key="911" v-if="billyType === '月账单'" style="padding-bottom: 100px;">
    ...
    <div class="money_box go go_bottom" ref="NumPad" :style="{height:h+'px'}">
      <div class="money_box_con">
        ...
        <NumberPad :value.sync="recordListItem.num" @submit="submit" :key="uns1" :style="{'padding-bottom': ph+'px'}"/>
